...
> **Перенесено из инфлюенс-конвейера.** Пути к файлам приведены к структуре этого репо,
> «канал автора» читается как «канал Кайтена», сет из 5 вариантов - как 3-5 вариантов поста.


> Операционная спецификация прогона скоринга. Методология линз - в
> [SCORING-METHOD.md](SCORING-METHOD.md), обвязка всего конвейера - в [RUNBOOK.md](RUNBOOK.md).
...
|---|---|---|---|
| **Канал** | `references/voice-profile.md` | Аудитория, оферта, табу, форматы | Persona-линза гадает |
...
| **Сегмент** | `references/personas.md` | Синтетическая панель ЦА сегмента | Оценка «средним читателем», которого не существует |
...
| | **ICP (`references/icp-kaiten.md`) - ОБЯЗАТЕЛЬНО** | Сегменты × роли × 3 вида боли + решение Kaiten + ценность + метрики + реальные кейсы/статьи. **Шаг 0 любого сета:** определить задетые ICP-роли, боли/пруфы брать дословно | Боли из головы, мимо ЦА |
...
| | `references/scoring-dataset.*` | Калибровка рубрики, уроки | Оценки плывут между прогонами |
...
1. **Якорный скоринг.** Перед выставлением баллов перечитать три якоря из
   `references/scoring-dataset.md`: верх (~86, Света З1 «Куда переехать из Notion»),
...
Общая панель ([personas.md](../references/personas.md)) отвечает «кто наш покупатель вообще».
Сегментная панель (`references/personas.md`) - «кто читает этот
